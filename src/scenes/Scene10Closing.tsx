...
export default function Scene10Closing({
  ...
  const daysToNext = Math.max(
    0,
    Math.ceil(
      (new Date(config.nextOccasion).getTime() - Date.now()) /
        86400000
    )
  )
  ...
  return (
    <div className="scene">
      ...
      {showLetter && (
        ...
        >
          <div
            className="scrap-card fx-pop-in"
            style={{
              textAlign: 'left',
              maxHeight: '80vh',
              overflowY: 'auto',
